...
<xsl:stylesheet version="2.0"
	...
	<xsl:template name="code.Country-Codes">
		...
		<xsl:choose>
      		...
      		<xsl:when test="$myparam.upper='BY'"><xsl:value-of select="$myparam"/> (Belarus)</xsl:when>
      		...
      		<xsl:when test="$myparam.upper='PS'"><xsl:value-of select="$myparam"/> (Palästinensische Gebiete)</xsl:when>
      		...
      		<xsl:when test="$myparam.upper='QU'"><xsl:value-of select="$myparam"/> (Unbekannt)</xsl:when>
      		...
      		<xsl:when test="$myparam.upper='XK'"><xsl:value-of select="$myparam"/> (Kosovo)</xsl:when>
